...
/**
 * Contact.Createorupdate API specification (optional)
 ...
 */
function _civicrm_api3_contact_Createorupdate_spec(&$spec) {
  $spec['magicword']['api.required'] = 1;
}

/**
 * Contact.Createorupdate API
 *
 * @param array $params
 *
 * @return array
 ...
 */
function civicrm_api3_contact_Createorupdate($params) {
  if (array_key_exists('magicword', $params) && $params['magicword'] == 'sesame') {
    ...
    return civicrm_api3_create_success($returnValues, $params, 'Contact', 'Createorupdate');
  }
  else {
